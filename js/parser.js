window.PARSER = /*
 * Generated by PEG.js 0.10.0. using grammer.pegjs
 *
 * http://pegjs.org/
 */
(function() {
  ...
  function peg$parse(input, options) {
    ...
    var peg$FAILED = {},
        ...
        peg$c35 = function(left, next, right) {
        	var str = 'var pointedNode9999=0; ' +
                      ...
                      'else if('+ left + '.constructor.name == "Node") ' +
                 		...
                 		console.log(str + next.join(''))
        				window.eval(str);
                        //console.log(eval('pointedNode9999.next.next'))
                        //console.log(eval(right+'.constructor.name  '));
                	   ...
                	   console.log(next.length +' ' +left+".drawArrow("+right+")");

                	   return left+'->'+right;
          },
        peg$c36 = function(left, right, next) {
