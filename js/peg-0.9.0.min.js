...
var PEG = function (undefined) {
	...
	return modules.define("utils/arrays", function (u, e) {
		...
		u.exports = function () {
			...
			function A(u) {
				...
				function i() {
					var u, e, A, t, r, n, E;
					if (u = jn, e = ee(), e !== Fe)
						if (A = jn, t = a(), t !== Fe ? (r = ee(), r !== Fe ? (t = [t, r], A = t) : (jn = A, A = Fe)) : (jn = A, A = Fe), A === Fe && (A = null), A !== Fe) {
							if (t = [], r = jn, n = F(), n !== Fe ? (E = ee(), E !== Fe ? (n = [n, E], r = n) : (jn = r, r = Fe)) : (jn = r, r = Fe), r !== Fe)
								for (; r !== Fe;) t.push(r), r = jn, n = F(), n !== Fe ? (E = ee(), E !== Fe ? (n = [n, E], r = n) : (jn = r, r = Fe)) : (jn = r, r = Fe);
							else t = Fe;
				...
				function M() {
					...
					if (e === Fe)
						if (e = jn, 39 === u.charCodeAt(jn) ? (A = WA, jn++) : (A = Fe, 0 === Gn && C(XA)), A !== Fe) {
				...
				function Y() {
					var e, A, t, r, n, E;
					if (Gn++, e = jn, 91 === u.charCodeAt(jn) ? (A = KA, jn++) : (A = Fe, 0 === Gn && C(QA)), A !== Fe)
						if (94 === u.charCodeAt(jn) ? (t = ut, jn++) : (t = Fe, 0 === Gn && C(et)), t === Fe && (t = null), t !== Fe) {
				...
				function Cu() {
					var e, A, t, r, n, E;
					if (e = jn, A = [], t = [], r = jn, n = jn, Gn++, Wt.test(u.charAt(jn)) ? (E = u.charAt(jn), jn++) : (E = Fe, 0 === Gn && C(Xt)), Gn--, E === Fe ? n = void 0 : (jn = n, n = Fe), n !== Fe ? (E = y(), E !== Fe ? (n = [n, E], r = n) : (jn = r, r = Fe)) : (jn = r, r = Fe), r !== Fe)
						for (; r !== Fe;) t.push(r), r = jn, n = jn, Gn++, Wt.test(u.charAt(jn)) ? (E = u.charAt(jn), jn++) : (E = Fe, 0 === Gn && C(Xt)), Gn--, E === Fe ? n = void 0 : (jn = n, n = Fe), n !== Fe ? (E = y(), E !== Fe ? (n = [n, E], r = n) : (jn = r, r = Fe)) : (jn = r, r = Fe);
					else t = Fe;
					for (t === Fe && (t = jn, 123 === u.charCodeAt(jn) ? (r = Mt, jn++) : (r = Fe, 0 === Gn && C(Gt)), r !== Fe ? (n = Cu(), n !== Fe ? (125 === u.charCodeAt(jn) ? (E = qt, jn++) : (E = Fe, 0 === Gn && C(Yt)), E !== Fe ? (r = [r, n, E], t = r) : (jn = t, t = Fe)) : (jn = t, t = Fe)) : (jn = t, t = Fe)); t !== Fe;) {
						if (A.push(t), t = [], r = jn, n = jn, Gn++, Wt.test(u.charAt(jn)) ? (E = u.charAt(jn), jn++) : (E = Fe, 0 === Gn && C(Xt)), Gn--, E === Fe ? n = void 0 : (jn = n, n = Fe), n !== Fe ? (E = y(), E !== Fe ? (n = [n, E], r = n) : (jn = r, r = Fe)) : (jn = r, r = Fe), r !== Fe)
							for (; r !== Fe;) t.push(r), r = jn, n = jn, Gn++, Wt.test(u.charAt(jn)) ? (E = u.charAt(jn), jn++) : (E = Fe, 0 === Gn && C(Xt)), Gn--, E === Fe ? n = void 0 : (jn = n, n = Fe), n !== Fe ? (E = y(), E !== Fe ? (n = [n, E], r = n) : (jn = r, r = Fe)) : (jn = r, r = Fe);
						else t = Fe;
				...
				var ie, ae = arguments.length > 1 ? arguments[1] : {},
					Fe = {},
					oe = {
						Grammar: i
					},
		...
		function A(u) {
			...
			var D = [],
				l = E.build({
					...
					action: function (u, e) {
						var t = r.clone(e.env),
							n = "sequence" !== u.expression.type || 0 === u.expression.elements.length,
							E = l(u.expression, {
								sp: e.sp + (n ? 1 : 0),
								env: t,
								action: u
					...
					sequence: function (u, e) {
						...
						return i([C.PUSH_CURR_POS], t(u.elements, {
							sp: e.sp + 1,
							env: e.env,
							action: e.action
						}))
					...
					labeled: function (u, e) {
						var A = r.clone(e.env);
						return e.env[u.label] = e.sp + 1, l(u.expression, {
							sp: e.sp,
							env: A,
							action: null
						})
		...
		function generateJavascript(ast, options) {
			...
			var parts = [],
				startRuleIndices, startRuleIndex, startRuleFunctions, startRuleFunction, ruleNames;
		...
		var A = e("./utils/arrays"),
			...
			r = {
				...
				buildParser: function (u) {
					...
					var r = arguments.length > 1 ? t.clone(arguments[1]) : {},
						n = "plugins" in r ? r.plugins : [],
						E = {
							parser: this.parser,
							passes: e(this.compiler.passes)
						};
